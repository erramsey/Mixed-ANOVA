This code is for a mixed ANOVA performed using the COMET dataset in the SASHELP library. The dataset was modified to resemble an experiment where a subject received multiple dosages, and a 
